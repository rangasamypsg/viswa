...
class Answer extends Model
{
    ...
    public static function saveCustomerFeedback( $data ){
        $answerId = Helper::__codeGeneration(Config::get('constant.VISWA.ANSWER'),Config::get('constant.FORMAT-CODE.ANS_CODE'));
