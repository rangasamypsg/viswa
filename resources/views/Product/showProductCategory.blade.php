...
<div class="widget">
	<header class="widget-header">
		...
		<div class="col-md-6">
			<a href="{{ route('Product.categorys') }}">
            ...
            @if(!empty( Auth::user()->role_name == "admin" ))
						<div class="dropdown parse">
								...
								<div id="mydropdown<?php echo $product->id; ?>" class="dropdown-content">
									<a href="#" class="soldout" data-id="{{ $product->id }}" id="sold_out_{{ $product->id }}" name="1">Favourites </a> <!--<i class="glyphicon glyphicon-chevron-up"></i> -->
								</div>
						</div>
            @endif
...
<script type="text/javascript">
	$(document).ready(function(){
				...
				$('.soldout').on('click',function(){	
					if (confirm('Are you sure you want to Sold out this Product?')) {		 
