...
<div class="col-md-12">
	<div class="widget">
		<header class="widget-header">
			<h4 class="col-md-6 widget-title">Experience Feedback</h4>
			<div class="col-md-6">
		...
		<div class="widget-body">
			 {!! Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'Question.store', 'method' => 'POST', 'role' => 'form']) !!}

                        {{ csrf_field() }} 
						
						<div class="form-group{{ $errors->has('text') ? ' has-error' : '' }}">
							{!! Form::label('Question','Question', array('class' => 'col-md-4 control-label')) !!} 							
							<div class="col-md-6">
								{{ Form::text('text', null, array('_required','class' => 'form-control','placeholder'=>'Your Question')) }} 
								@if ($errors->has('text'))
