...
<div class="col-md-12">
	<div class="widget">
		<header class="widget-header">
			<h4 class="col-md-6 widget-title">Customer Master</h4>
			<div class="col-md-6">
		...
		<hr class="widget-separator">
			<div class="widget-body">
				{!! Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'Vendor.store', 'method' => 'POST', 'role' => 'form']) !!}
						...
						<!-- <div class="form-group{{ $errors->has('preference') ? ' has-error' : '' }}">
							...
							<div class="col-md-6">
								<ul class="preferences">
									<li style="float: left">
										{!! Form::checkbox("preference[ring]", 'ring', true, ['class' => 'checkbox']) !!} Ring
									</li>
									<li style="float: left">
										{!! Form::checkbox("preference[bracelet]", 'bracelet', false, ['class' => 'checkbox']) !!} Bracelet
									</li>
									<li style="float: left">
										{!! Form::checkbox("preference[chain]", 'chain', false, ['class' => 'checkbox']) !!} Chain
									</li>
								</ul>
						...
						<div class="form-group">
							<div class="col-md-6 col-md-offset-4">
								{!! Form::submit('Add Customer',array('class'=>'btn btn-primary'),'<i class="fa fa-btn fa-user"></i>') !!}
